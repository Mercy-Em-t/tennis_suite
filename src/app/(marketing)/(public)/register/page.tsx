...
function OnboardingWizard() {
  ...
  return (
    <Card style={{ padding: '2rem', width: '480px', background: '#161b22', border: '1px solid rgba(255,255,255,0.1)' }}>
      ...
      {step === 1 && (
        <div style={{ textAlign: 'center', marginTop: '1.5rem', fontSize: '0.875rem', color: '#8b949e', display: 'flex', flexDirection: 'column', gap: '8px' }}>
          <p style={{ margin: 0 }}>
            Already registered? <a href="/login" style={{ color: '#58a6ff', textDecoration: 'none' }}>Login Here</a>
          </p>
          <p style={{ margin: 0 }}>
            Want to host a tournament? <a href="/host-onboarding" style={{ color: 'var(--accent)', textDecoration: 'none' }}>Sign up as an Organizer</a>
          </p>
        </div>
      )}
    </Card>
